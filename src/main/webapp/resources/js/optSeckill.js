...
var seckill= {
    ...
    URL :{
        now:function () {
            return '/optSeckill/time/now';
        },
        exposer:function(seckillId){
            return '/optSeckill/'+seckillId+"/exposer";
        },
        execution :function (seckillId, md5) {
            return '/optSeckill/'+seckillId+'/'+md5+'/execution';
        }
    },
            ...
            if(!seckill.validatePhone(killPhone)){
                ...
                $('#killPhoneBtn').click(function () {
                    ...
                    if (seckill.validatePhone(inputPhone)) {
                        //电话写入cookie
                        $.cookie('killPhone', inputPhone, {expires: 7, path: '/optSeckill'});
                        //刷新界面
